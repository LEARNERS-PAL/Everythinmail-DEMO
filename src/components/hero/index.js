    ...
    <>
      ...
      <section className=" hero-email min-h-screen bg-cover bg-center bg-no-repeat font-inter">
        <article className="min-h-[90vh] flex flex-col gap-6 justify-center items-center">
          <h1 className="lg:text-6xl text-3xl flex flex-col font-extrabold text-black text-center lg:max-w-4xl leading-tight">
          ...
          <div className="flex items center justify-center w-full gap-3">
            ...
            <a
              ...
              target="_blank"
            >
              <button className="bg-black text-white py-3 lg:px-14 px-6 rounded-sm border-[2px] border-black">
                Get Started
              </button>
            </a>
            <Link href="/form">
              <button className="bg-white text-black py-3 lg:px-14 px-6 rounded-sm border-[2px] border-black">
                View Demo
              </button>
            </Link>
          </div>
